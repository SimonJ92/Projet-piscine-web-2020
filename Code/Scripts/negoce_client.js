...
function afficheaccepter(gridCheck) {
	if (gridCheck.checked)
	{
		document.getElementById("accepter").style.display="block";
		document.getElementById("accepterdisabled").style.display="none";
	}
	else{
		document.getElementById("accepter").style.display="none";
		document.getElementById("accepterdisabled").style.display="block";
	}
